        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-5 items-center justify-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-full bg-[#c62a5e] px-7 py-3.5 text-sm font-bold text-white transition-colors hover:bg-[#a62350]"
            >
            ...
            <a
              href="/booking"
              className="text-white underline underline-offset-4 text-sm uppercase tracking-widest font-bold transition-colors"
            >
              {t.cta.book}
            </a>
          </div>
